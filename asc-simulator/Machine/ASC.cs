...
namespace Simulator.Machine
{
    ...
    public class ASC : IDisposable
    {
        ...
        // 命令サイクル中に呼び出されるイベント
        public event CycleEventHandler CycleBegin;
        public event CycleEventHandler CycleEnd;
        public event CycleEventHandler CycleDecode;
        public event CycleEventHandler CycleUpdateIR;
        public event CycleEventHandler CycleOpecode;
        public event CycleEventHandler CycleUpdatePC;

        // ステップ実行が終了したとき
        public event CycleEventHandler Stepped;
        ...
        public void RunOperate()
        {
            ...
            this._Mode = StopMode.PerOperation;
        }
